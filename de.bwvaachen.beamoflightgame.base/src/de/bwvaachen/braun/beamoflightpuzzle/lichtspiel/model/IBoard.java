...
public interface IBoard {
	...
	public Tile getTileAt(int x, int y) throws IndexOutOfBoundsException;
	public boolean isPlacementOfTilePossible(Tile t, int x, int y);
	public void setTileAt(int x, int y, Tile t) throws IndexOutOfBoundsException, IllegalPlacementException;
}
